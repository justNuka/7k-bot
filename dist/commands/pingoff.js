...
export const data = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: 'remonter_info', value: 'remonter_info' }, { name: 'signaler_membre', value: 'signaler_membre' }, { name: 'autre', value: 'autre' }))
    .addStringOption(o => o
    .setName('message')
        ...
        if (officier) {
            ...
            try {
                ...
                if (!base || base.type !== ChannelType.GuildText) {
                    await interaction.editReply('⚠️ Impossible d’envoyer un DM à cet officier **et** de créer un fil privé (salon retours introuvable).');
                    return;
                }
                try {
                    ...
                    await interaction.editReply('⚠️ DM impossible et création de fil privé échouée (permissions ?). Réessaie plus tard.');
                }
                return;
            }
        }
