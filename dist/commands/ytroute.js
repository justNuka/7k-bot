...
import { listRoutes, insertThreadRoute, insertForumRoute, deleteRoute } from '../db/ytRoutes.js';
...
export async function execute(interaction) {
    ...
    try {
        ...
        if (sub === 'add-thread') {
            ...
            const th = interaction.options.getChannel('thread', true);
            // validation regex
        ...
        if (sub === 'list') {
            ...
            if (!routes.length)
                return officerEdit(interaction, 'Aucune route.');
