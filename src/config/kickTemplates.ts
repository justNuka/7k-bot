export type KickTemplate = {
  id: string;            // valeur technique
  label: string;         // libellé visible dans le menu
  title: string;         // titre d’embed
  body: string;          // markdown, peut contenir {member} et {note}
};

export const KICK_TEMPLATES: KickTemplate[] = [
  {
    id: 'inactif',
